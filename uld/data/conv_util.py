...
class ConvTemplate:
    def __init__(self, question_start_token, question_end_token, answer_token, strip_prompt: bool = True, **kwargs) -> None:
        self.question_start_token = question_start_token
        self.question_end_token = question_end_token
        self.answer_token = answer_token
        self.strip_prompt = bool(strip_prompt)
    ...
    def prepare_gen_prompt(self, question=None, answer=None, **kwargs):
        if question != None:
            ...
            return s.strip() if self.strip_prompt else s
